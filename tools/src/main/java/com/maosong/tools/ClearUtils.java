...
public class ClearUtils {
     ...
     * 清除应用所有的数据
     */
    public static void clearAllDataOfApplication(Context context, String... customfilepath) {
     ...
     * 按名字清除数据库
     */
    public static void clearDatabaseBydbName(Context context, String dbName) {
