        ...
        if (myShape != null) {
            ...
            switch (myShape) {
                ...
                case RECTANGULAR://圆角矩形
                    //RectF对象
                    oval.left = center[0] - targetViewWidth / 2;                              //左边
                    oval.top = center[1] - targetViewHeight / 2;                                   //上边
                    oval.right = center[0] + targetViewWidth / 2;                             //右边
                    oval.bottom = center[1] + targetViewHeight / 2;                                //下边
